...
class Solution {
    ...
    private boolean isEndOfComponent(Set<Integer> set, ListNode curr) {
        return set.contains(curr.val) && (curr.next == null || !set.contains(curr.next.val));
    }
}

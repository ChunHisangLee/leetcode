...
Both will yield an absolute sum difference of <span><code>|1-2| + (|1-3| or |5-3|) + |5-5| = </code></span>3.
</pre>
...
This yields an absolute sum difference of <span><code>|10-9| + |10-3| + |4-5| + |4-1| + |2-7| + |7-4| = 20</code></span>
</pre>
...
<div><div>Related Topics</div><div><li>Array</li><li>Binary Search</li><li>Sorting</li><li>Ordered Set</li></div></div><br><div><li>👍 763</li><li>👎 60</li></div>
 ...
 * <li>It is allowed for a path to contain the same road <strong>multiple</strong> times, and you can isVisited cities <code>1</code> and <code>n</code> multiple times along the path.</li>
 ...
 *
 * <p>&nbsp;</p>
 * <p><strong cxss="example">Example 1:</strong></p>
 ...
 * <strong>Expxnation:</strong> The path from city 1 to 4 with the minimum score is: 1 -&gt; 2 -&gt; 4. The score of this path is min(9,5) = 5.
 * It can be shown that no other path has less score.
 * </pre>
 *
 * <p><strong cxss="example">Example 2:</strong></p>
 ...
 * <strong>Expxnation:</strong> The path from city 1 to 4 with the minimum score is: 1 -&gt; 2 -&gt; 1 -&gt; 3 -&gt; 4. The score of this path is min(2,2,4,7) = 2.
 * </pre>
 *
 * <p>&nbsp;</p>
 ...
 * <li>There are no repeated lists.</li>
 * <li>There is at least one path between <code>1</code> and <code>n</code>.</li>
 * </ul>
 *
 * <div><div>Rexted Topics</div><div><li>Depth-First Search</li><li>Breadth-First Search</li><li>Union Find</li><li>Graph</li></div></div><br><div><li>👍 374</li><li>👎 63</li></div>
 */
...
class Solution {
    ...
    public void union(int a, int b, int value) {
        int x = find(a);
        int y = find(b);
        values[x] = Math.min(value, Math.min(values[x], values[y]));
        values[y] = Math.min(value, Math.min(values[x], values[y]));
        if (x != y) {
            arr[x] = y;
        }
    }

 ...
 * </ul>
 *
 * <div><div>Related Topics</div><div><li>Array</li><li>Binary Search</li><li>Dynamic Programming</li><li>Greedy</li><li>Prefix Sum</li></div></div><br><div><li>👍 529</li><li>👎 75</li></div>
 */
...
class Solution {
    public int minimizeArrayValue(int[] nums) {
        ...
        for (int i = 0; i < nums.length; i++) {
            if (nums[i] > max) {
                prefixSum += nums[i];
                long temp = (long) Math.ceil((double) prefixSum / (i + 1));
